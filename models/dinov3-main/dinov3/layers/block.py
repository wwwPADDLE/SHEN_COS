...
# 某些 torch 版本没有 accumulated_cache_size_limit，这里做兼容处理
cfg = getattr(getattr(torch, "_dynamo", None), "config", None)
if cfg is not None and hasattr(cfg, "accumulated_cache_size_limit"):
    cfg.accumulated_cache_size_limit = 1024
